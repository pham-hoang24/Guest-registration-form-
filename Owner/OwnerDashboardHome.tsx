 ...
 *
 * Dashboard home page (route: /owner).
 *
 * • Fetches GET /v1/owner/properties (real endpoint or MSW mock in dev).
 * • Displays a property strip: each card links to
 *   /owner/properties/:id/submissions.
